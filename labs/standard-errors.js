...
<p>Here is the same repetition as a Galton board, one ball per study. Each ball lands at its study's estimate and carries that study's 95% interval, estimate ± 1.96 SE. When the SE is a good estimate of the pile's SD, about 95 of every 100 intervals cover the truth, and the counter says so. The orange board is a preview of a later step: the plug-in's SE describes its own spread well, yet its intervals miss, because its pile is centred at 2.64.</p>
<div data-figure="galton" data-n="400" data-arrows="0" data-boards="both"></div>
