...
(function () {
  ...
  // Estimated working time per lesson: reading at about 150 words per minute, plus roughly two
  // minutes per interactive figure and per exercise, a quarter more for derivation-heavy lessons,
  // rounded to five. These are estimates, not observed completion times.
  const minutes = {
    "causal-roadmap": 25,
    "intercurrent-events": 25,
    "target-trial": 25,
    "clone-censor-weight": 25,
    "rct-adjustment": 35,
    "scores-from-scratch": 40,
    "mean-along-a-path": 25,
    "under-the-integral": 15,
    "canonical-gradient": 25,
    "one-step-estimator": 15,
    "two-strata": 35,
    "clever-covariate": 25,
    "one-move-two-faces": 15,
    "four-patients": 15,
    "efficiency-theory-story": 30,
    "inference-lab": 25,
    "standard-errors": 50,
    "positivity": 35,
    "sensitivity": 30,
